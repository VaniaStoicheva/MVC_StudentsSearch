        ...
        <table border="1">
            <thead>
                ...
                <tr>
                    ...
                    <th>Лекции</th><th>Упражнения</th><th>Оценки</th>
                    <th><?=
                        anchor(site_url('Search/display/sum(subject_workload_lectures)/') . '/'
                                . (($sort_order == 'asc' ) ? 'desc' : 'asc'), ' хорариум лекции');
                        ?>
                    </th>
                    <th><?=
                        anchor(site_url('Search/display/student_id/') . '/'
                                . (($sort_order == 'asc' ) ? 'desc' : 'asc'), ' хорариум упражнения');
                        ?> 
                    </th>
                    <th><?=
                        anchor(site_url('Search/display/assesment/') . '/'
                                . (($sort_order == 'asc' ) ? 'desc' : 'asc'), ' среден успех');
                        ?> 
                    </th>
                </tr>
            </thead>
